...
function SM3() {
	...
	$.each(filteredData, function (surveyIndex, survey) {
		if (survey[dk] === "n/a") {
			...
			if (survey["SM3-A"] === "T" || survey["SM3-B"] === "T" || survey["SM3-C"] === "T") {
				homeCare++;
			}
			if (survey["SM3-D"] === "T" || survey["SM3-E"] === "T" || survey["SM3-F"] === "T" || survey["SM3-G"] === "T") {
				publicCare++;
			}
			if (survey["SM3-H"] === "T" || survey["SM3-I"] === "T") {
				privateCare++;
			}
		}
	});
...
function DI2() {
	...
	$.each(filteredData, function (surveyIndex, survey) {
		...
		if (survey[nothing] === "n/a") {
			notAskedCount++;
		} else if (survey[nothing] === "T") {
			nothingCount++;
		} else if (survey[skip] === "T") {
			skipped++;
		} else {
			var thisTrueCount = 0;
